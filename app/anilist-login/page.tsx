          ...
          <Card className="overflow-hidden border-0 bg-white shadow-2xl dark:bg-gray-800">
            <div className="flex flex-col md:flex-row">
              ...
              <motion.div
                variants={fadeInLeft}
                className="
                  flex flex-col items-center justify-center bg-linear-to-br from-blue-50
                  to-indigo-100 p-8
                  md:w-1/2
              ...
              >
                ...
                >
                  ...
                  <motion.div
                    className="
                      absolute inset-0 rounded-lg bg-linear-to-t from-blue-900/30 to-transparent
                    "
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
              ...
              <motion.div
                ...
                className="flex flex-col bg-white p-8 md:w-1/2 dark:bg-gray-800"
              >
                <CardHeader className="px-0 pt-0">
                  ...
                  >
                    <CardTitle className="
                      bg-linear-to-r from-blue-600 to-indigo-600 bg-clip-text text-2xl font-bold
                      text-transparent
                    ...
                    {isLoggedIn && !loadingUserData ? (
                      ...
                      >
                        <div className="flex items-center">
                          <Avatar className="
                            size-12 border-2 border-white shadow-md
                      ...
                      <div className="
                        ...
                        dark:border-gray-700 dark:bg-gray-700/20
                      ">
                        <div className="flex items-center">
                    ...
                    {!isLoggedIn && (
                      ...
                      >
                        <Button
                          onClick={handleLogin}
                          className="
                            flex w-full items-center justify-center rounded-md bg-linear-to-r
                            from-blue-600 to-indigo-600 py-3 text-white shadow-md transition-all
                            duration-300
                    ...
                    {isLoggedIn && (
                      <div className="w-full">
                        <Button
                          ...
                          onClick={logout}
                          className="
                            flex w-full items-center justify-center rounded-md border-gray-300 py-3
                            text-gray-700 shadow-sm transition-colors
                            hover:bg-gray-100 hover:text-gray-900
                            dark:border-blue-600 dark:bg-gray-800 dark:text-blue-300
                ...
                <CardFooter className="mt-auto px-0 pt-6 pb-0">
                  <div className="
                    flex w-full flex-col justify-between space-y-3
                  ...
                  ">
                    ...
                    >
                      <Button
                        ...
                        onClick={handleHome}
                        className="
                          flex w-full items-center justify-center border-gray-200 bg-gray-100
                          text-gray-800
                          hover:bg-gray-200
                          sm:w-auto
                    ...
                    >
                      <Button
                        ...
                        disabled={!isLoggedIn}
                        className={`
                          flex w-full items-center justify-center bg-linear-to-r from-blue-600
                          to-indigo-600 text-white shadow-md transition-all duration-300
                          hover:from-blue-700 hover:to-indigo-700
                          dark:from-blue-500 dark:to-indigo-500
                          dark:hover:from-blue-600 dark:hover:to-indigo-600
                          ${
                ...
                {isProcessing && (
                  ...
                  >
                    <div className="relative size-6">
                      <motion.div
                        className="
                          absolute inset-0 rounded-full border-2 border-blue-500 opacity-75
